...
const RegisterUserPage = () => {
  ...
  const runValidation = useCallback(
    (
      ...
      const validation =
        validationOverride ??
        validateUserForm(nextValues, { mode: "create", regions });
  ...
  const handleInputChange = (event: ChangeEvent<HTMLInputElement>) => {
    ...
    const validation = validateUserForm(nextValues, {
      mode: "create",
      regions,
    });
  ...
  const handleRunDigitChange = (event: ChangeEvent<HTMLInputElement>) => {
    const verifier = event.currentTarget.value
      .replace(/[^0-9kK]/g, "")
      .toUpperCase()
      .slice(0, 1);
  ...
  const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
    ...
    try {
      // Construct Usuario object from form values
      const usuarioRegister: any = {
        ...mapFormToStoredUser(values, null, regions),
        // Override run to match backend expectation
        run: parseInt(values.runBody),
        dv: values.runDigit,
        password: values.password,
      };

      await userService.add(usuarioRegister);
            ...
            <div className="col-11 col-md-10 col-lg-6">
              ...
              >
                ...
                <div>
                  ...
                  >
                    Accede a beneficios dulces, seguimiento de pedidos y
            ...
            <div className="col-12 col-lg-8 col-xl-6">
              <div className="bg-body border rounded-3 shadow-sm p-4 p-lg-5">
                <header className="d-flex align-items-start justify-content-between mb-4">
                  <div>
                    <span className="badge text-uppercase fw-semibold mb-2">
                      Nuevo registro
                    </span>
                ...
                <p className="mb-4">
                  Completa tus datos para disfrutar de promociones
                  personalizadas y un proceso de compra más ágil.
                </p>
                    ...
                    <input
                      ...
                      onBlur={() => {
                        const nextTouched: Partial<
                          Record<keyof UserFormValues, boolean>
                        > = {
                          ...touched,
                          termsAccepted: true,
                        };
