...
/* ============================================================
   PÁGINA PRINCIPAL REFACTORIZADA Y LIMPIA
============================================================ */
const ReportsPage = () => {
  /* =========================
     1. DATOS GLOBALES
  ...
  const pedidosHoy = pedidos.filter((p) =>
    p.fechaPedido.startsWith(todayString)
  );
  ...
  const comentariosPendientes = comentarios.length;
          ...
          <div className="col-6 col-md-3">
            <div className="card shadow-sm p-3">
              ...
              <h3 className="fw-bold">
                {Object.keys(resumenCategorias).length}
              </h3>
            </div>
          </div>
